...
otu_table <-  read.table ("../../Data/16S.otu_table.taxonomy.txt",
                          check.names = FALSE,
                          header = TRUE,
                          dec = ".",
                          sep = "\t",
...
heat_tree(metamapa, 
          ...
          output_file = "../../Figures/Asymtomatic_samples_16S.png")
...
heat_tree_matrix(metamapa,
                 ...
                 output_file = "../../Figures/differential_heat_tree_16S.png") # Saves the plot as a pdf file
