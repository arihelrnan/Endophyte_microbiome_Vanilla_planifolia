...
input_tree = "16S_tree"                   #<--- CHANGE ACCORDINGLY !!!
...
View(distancia)
library(gplots)
heatmap.2(distancia, key=T, trace="none", ColSideColors = c(rep("red",2),rep("green",3),rep("yellow",2),rep("aquamarine",1),rep("maroon1",2),rep("blue",2),rep("red",1)), RowSideColors = c(rep("red",2),rep("green",3),rep("yellow",2),rep("aquamarine",1),rep("maroon1",2),rep("blue",2),rep("red",1)))
