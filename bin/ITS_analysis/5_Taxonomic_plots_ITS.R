...
heat_tree(metamapa, 
          ...
          output_file = "../../Figures/Taxonomic_plots/Root_samples_ITS.png")
...
heat_tree(metamapa, 
          ...
          node_color_axis_label = "Mean of OTUs",
          node_size_axis_label = "Number of samples",
          output_file = "../../Figures/Taxonomic_plots/Stem_samples_ITS.png")
...
heat_tree(metamapa, 
          ...
          node_color_axis_label = "Mean of OTUs",
          node_size_axis_label = "Number of samples",
          output_file = "../../Figures/Taxonomic_plots/Asymptomatic_samples_ITS.png")
...
heat_tree(metamapa, 
          ...
          node_color_axis_label = "Mean of OTUs",
          node_size_axis_label = "Number of samples",
          output_file = "../../Figures/Taxonomic_plots/Symptomatic_samples_ITS.png")
...
heat_tree(metamapa, 
          ...
          node_color_axis_label = "Mean of OTUs",
          node_size_axis_label = "Number of samples",
          output_file = "../../Figures/Taxonomic_plots/Wild_samples_ITS.png")
...
heat_tree(metamapa, 
          ...
          node_size_axis_label = "Number of samples",
          output_file = "../../Figures/Taxonomic_plots/Taxonomy_ITS.png")